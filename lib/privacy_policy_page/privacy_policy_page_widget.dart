      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection('5. Data Security', 'We implement technical and organizational measures to protect your data, including encryption, secure transmission, and access controls. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.'),
            _buildSection('6. Your Rights', 'Depending on your location, you may have the right to: access your personal data; correct inaccurate data; request deletion of your data; object to or restrict certain processing; data portability; and withdraw consent. You can exercise these rights through the app settings or by contacting us. In India, you may also have rights under applicable data protection laws.'),
            _buildSection('7. Location Data', 'We collect location data when you use the app to provide ride services. This is essential for matching with riders, navigation, and ride tracking. You can control location permissions in your device settings, but disabling location may limit app functionality.'),
            _buildSection('8. Children\'s Privacy', 'The UGO Driver App is not intended for users under 18 years of age. We do not knowingly collect information from children. If you believe we have collected data from a minor, please contact us to have it removed.'),
            _buildSection('9. Changes to This Policy', 'We may update this Privacy Policy from time to time. We will notify you of material changes through the app or by other reasonable means. Your continued use of the App after such changes constitutes acceptance of the updated Policy.'),
            _buildSection('10. Contact Us', 'For questions about this Privacy Policy or your personal data, please contact us through the in-app support feature or at the contact details provided in the App.'),
