                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '0sx5can7' /* Promotional offers, discounts ... */,
                          ),
                          style:
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '8768rwio' /* Ugo One membership benefits an... */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodySmall.override(
                                    font: GoogleFonts.inter(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '98202sfo' /* New product updates and intere... */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodySmall.override(
                                    font: GoogleFonts.inter(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'msr0xh2v' /* Personalized trip suggestions */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodySmall.override(
                                    font: GoogleFonts.inter(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            '73qwhbgg' /* User research and marketing su... */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodySmall.override(
                                    font: GoogleFonts.inter(
