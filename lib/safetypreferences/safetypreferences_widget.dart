                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '6uu87tpc' /* Get more safety check-ins */,
                                        ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'a3btvneb' /* only turn on manually */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
