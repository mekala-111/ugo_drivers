...
class RegistrationUpdateWidget extends StatefulWidget {
  const RegistrationUpdateWidget({super.key});

  static String routeName = 'RegistrationImageUpdate';
  static String routePath = '/registrationImageUpdate';

  @override
  State<RegistrationUpdateWidget> createState() =>
      _RegistrationUpdateWidgetState();
}

class _RegistrationUpdateWidgetState extends State<RegistrationUpdateWidget>
